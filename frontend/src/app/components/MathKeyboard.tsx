...
export function MathKeyboard({ onInsert }: MathKeyboardProps) {
  ...
  return (
    <div className={`${bgSecondary} rounded-lg p-4 border ${border}`}>
          ...
          <button
            ...
            className={`
              ...
              ${button.type === 'function' 
                ...
                ? isDark
                  ? 'bg-[#22D3EE]/10 hover:bg-[#22D3EE]/20 text-[#22D3EE] border border-[#22D3EE]/30'
                  : 'bg-[#0891B2]/10 hover:bg-[#0891B2]/20 text-[#0891B2] border border-[#0891B2]/30'
                : isDark
                  ? 'bg-[#334155]/40 hover:bg-[#334155]/60 text-[#CBD5E1] border border-[#334155]'
                  : 'bg-[#E2E8F0] hover:bg-[#CBD5E1] text-[#334155] border border-[#CBD5E1]'
              }
            `}
            title={button.value}
          >
